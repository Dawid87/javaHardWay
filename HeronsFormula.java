public class HeronsFormula {
	...
	// This function coputes the area of a triangle with side lengths a, b, & c.
...
/* Study Drills:
1. The version of the code with functions is much shorter than that without.

2. It would have been much more difficult to fix the division bug 
without functions.

3. Using functions makes it very simple to add additional tests.
*/